...
$stmt = $dbh->prepare("SELECT * FROM tblstaff WHERE staffID=?");
...
$_SESSION['error'] ='Username Already Exist in our Database ';
 ...
 //Add User details
 $staffID= 'STAFF/FKP/'.date("Y").'/'.rand(1000,5009); 
 $spassword= 'admin123'; 
$sql = 'INSERT INTO tblstaff(staffID,sfullname,spassword,ssex,semail,sdob,sphone,sJobtitle,photo) VALUES(:staffID,:sfullname,:spassword,:ssex,:semail,:sdob,:sphone,:sJobtitle,:photo)';
              ...
              <form  action="" method="POST" enctype="multipart/form-data">
				...
				<div class="col-lg-4 col-md-12 form-group mb-2">
				  ...
				  <div class="col-lg-4 col-md-12 form-group mb-2">
                    ...
                    <input type="tel" class="form-control" name="sphone" id="txtphone" size="77" value="" placeholder="Enter Phone">
                  </div>
				  ...
				  <div class="col-lg-4 col-md-12 form-group mb-2">
                   ...
                   <div class="col-lg-4 col-md-12 form-group mb-2">
                    ...
                    <input type="password" class="form-control" name="spassword" id="exampleInputPassword1" size="77" value="" placeholder="Enter Password">
                  </div>
