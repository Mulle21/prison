  ...
  <a href="#" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <img src="../uploadImage/Profile/<?php echo $admin_photo;    ?>" alt="User Image" width="140" height="141" class="img-circle elevation-2">        </div>
        <div class="info">
      ...
      <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-primary">
          <div class="inner">
            ...
            <p><strong>No. of Declined Leave/Bail </strong></p>
          </div>
          <div class="icon">
            <i class=""></i>
          </div>
