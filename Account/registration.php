                ...
                <div class="form-content" style="max-height: unset;">
                    ...
                    <img src="../image/logo.png" alt="" class="logo-light" height="81">
                        ...
                        <div class="card-header d-flex flex-wrap">
                            ...
                            <h4 class="mr-auto my-auto text-center">Registration</h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 form-group mb-2">
                                            ...
                                            <select class="form-control" required data-validation-required-message="Select Employee Department" data-val="true" data-val-required="The Employee Department field is required." id="cmddept" name="cmddept">
                                                    <option value="">... Select Department/Court ...</option>
                                        ...
                                        <div class="col-lg-6 col-md-12 form-group mb-2">
                                            <div class="controls">
                                            <input class="form-control" type="number" placeholder="Basic Salary" data-validation-required-message="Basic Salary is required" data-val="true" id="txtbasic_salary" name="txtbasic_salary" value="">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 form-group mb-2">
                                            <div class="controls">
                                            <input class="form-control" type="number" placeholder="Gross Pay" data-validation-required-message="Gross Pay is required" data-val="true" id="txtgross_pay" name="txtgross_pay" value="">
