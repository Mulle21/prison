...
<title><?php echo $fname; ?><?php echo $fname; ?><?php echo $fname; ?>'s Profile | <?php echo $sitename ;?></title>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
                            <div class="ibox-content no-padding border-left-right">
                                <img src="../<?php echo $photo ;?>" alt="image" width="auto" height="auto" >                            </div>
                            <div class="ibox-content profile-content">
                                <h4><strong><?php echo $fname ;?></strong></h4>
                                 <h5><strong>Employee ID</strong>: <?php echo $IID ;?></h5>
								  <h5><strong>F</strong>: <?php echo $isex ;?></h5>
                                 <h5><strong>Email</strong>: <?php echo $iemail ;?></h5>
								...
								<div class="col-sm-4 b-r">
                                    ...
                                    <div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            ...
                                            <strong>Fullname :</strong>                    <?php echo $rowaccess['iname'];   ?> <br>
                                      </div>
                                    </div>
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
