...
<body>
    ...
    <div id="wrapper">
<?php
                  $data = $dbh->query("select * FROM tblinmate");
                  $cnt=1;
      {
                    ?>
            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
						...
						<div align="center" class="style2"><span class="controls"><img src="image/<?php echo $row['photo'];?>"  width="50" height="43" border="2"/></span></div></td>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear"><span class="text-muted text-xs block"><?php echo $sfullname;  ?> <b class="caret"></b></span> </span> </a>
            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins"><?php echo $photo; ?></h3>
                                <small> </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><span class="label label-info pull-right">mu</span>
                                </h5>
                            </div>

                            <div class="ibox-content">
                                <h3 class="no-margins">N<?php echo number_format((float) $isex, 2); ?>
                                </h3>
                                <small> </small>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><span class="label label-info pull-right">Gender</span>
                                </h5>
                            </div>

                            <div class="ibox-content">
                                <h3 class="no-margins">N<?php echo number_format((float) $sphoto, 2); ?>
                                </h3>
                                <small> </small>
                            </div>
                        </div>
