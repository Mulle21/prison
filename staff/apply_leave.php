...
$selectquery="SELECT * FROM tblstaff ORDER BY staffID DESC LIMIT 1";
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Visitor Application </strong></li>
                    </ol>
                </div>
                <div class="col-lg-2">
					...
					<div class="ibox-content">
                        <div class="row">
						 <div class="col-sm-4 b-r">
                                    ...
                                    <label>IID</label></strong>
                                    <select class="form-control" id="cmdreason" name="cmdreason" required>
                                                    <option value="">Select Reason</option>
													<?php
                  $data = $dbh->query("select * FROM tblstaff");?>
                                                    <option value="Sick Leave"><?php echo $row['s'];  ?></option>
