...
$sstatus = 'Active';
 ...
 $sql = "SELECT * FROM tblstaff WHERE staffID='" .$staffID. "' and spassword = '".$spassword."'  and sstatus = '".$sstatus."'";
        ...
        <div>
            ...
            <form class="m-t" role="form" method= "POST" action="">
                <div class="form-group">
                    <input type="text" name="staffID" class="form-control" placeholder="Email" required="">
                </div>
                <div class="form-group">
                    <input type="password" name="spassword" class="form-control" placeholder="Password" required="">
                </div>
