        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-7">
                <div class="ibox float-e-margins">
					...
					<?php
	$sql = "select * from tblofficer where email='$email'"; 
...
$row= mysqli_fetch_array($result);
             ...
             <div class="form-group"><strong>
                                ...
                                <p class="text-center">
                                  <input name="userImage" type="file" class="inputFile" accept="image/JPEG,image/PNG,image/jpg" onChange="display_img(this)"/>
                                </p>   
                             </div>
