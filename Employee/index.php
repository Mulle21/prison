...
if (empty($_SESSION['tbluser-uemail'])) 
...
<head>
    ...
    <title>Employee Dashboard|<?php echo $ufname ;?></title>
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear"><span class="text-muted text-xs block"><?php echo $uemail;  ?> <b class="caret"></b></span> </span> </a>
                ...
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            ...
                            <span class="m-r-sm text-muted welcome-message">Welcome to <?php echo $ufname; ?></span>
                        </li>
                        <li class="dropdown">
                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h3 class="no-margins"><?php echo $userID; ?></h3>
                                <small> </small>
                            </div>
                        </div>
                    </div>
