...
<div class="container-fluid">
	...
	<div class="content py-4 bg-gradient-navy px-3">
		...
		<div class="form-group">
			...
			<select name="inmate_id" id="inmate_id" class="required form-control" required="required">
		...
		<div class="form-group">
			...
			<input type="text" name="fullname" id="fullname" class="required form-control" value="<?php echo isset($fullname) ? $fullname : ''; ?>"  required/>
		</div>
		<div class="form-group">
			<label for="contact" class="control-label">Contact #</label>
			<input type="text" name="contact" id="contact" class="required form-control" value="<?php echo isset($contact) ? $contact : ''; ?>"  required/>
		</div>
		<div class="form-group">
			<label for="relation" class="control-label">Relation</label>
			<input type="text" name="relation" id="relation" class="required form-control" value="<?php echo isset($relation) ? $relation : ''; ?>"  required/>
		</div>
	</form>
</div>
<script>
