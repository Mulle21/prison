        ...
        <div class="card rounded-0 shadow">
            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="required form-control" name="code" id="code" required="required" value="<?= isset($code) ? $code : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="cell_id" class="control-label">Prison & Cell Block</label>
                                        <select class="required form-control" name="cell_id" id="cell_id" required="required">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="required form-control" name="firstname" id="firstname" required="required" value="<?= isset($firstname) ? $firstname : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="middlename" class="control-label">Middle Name</label>
                                    <input type="text" class="required form-control" name="middlename" id="middlename" placeholder="optional" value="<?= isset($middlename) ? $middlename : "" ?>">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="lastname" class="control-label">Last Name</label>
                                    <input type="text" class="required form-control" name="lastname" id="lastname" required="required" value="<?= isset($lastname) ? $lastname : "" ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select class="required form-control" name="sex" id="sex" required="required">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file custom-file-sm rounded-0">
                                            <input type="file" class="custom-file-input rounded-0" id="customFile1" name="cimg" onchange="displayImg(this)">
			   ...
			   <div class="card-footer py-1 text-center">
                ...
                <button class="btn btn-lg btn-block btn-outline-success" form="inmate-form"><i class="fa fa-save"></i> Save</button>
                <?php if(!isset($id)): ?>
               </div>
			   <div class="col-md-3 col-sm-12">
                <a type="button" class="btn btn-lg btn-block btn-outline-danger" href="./?page=inmates"<i class="fa fa-angle-left"></i> Cancel</a>
                <?php endif; ?>
            </div>
			</div>
			</div>
