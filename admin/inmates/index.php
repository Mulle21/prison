...
<div class="card card-outline rounded-0 card-navy">
	<div class="card-header">
		...
		<div class="card-tools">
		 <a href="./?page=inmates/manage_inmate"  id="create_new" class="btn m-t-20 btn-info btn-block waves-effect waves-light"><i class="ti-plus"></i> Create New</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td align="center">
								 <button type="button" class="btn m-t-20 btn-info btn-block waves-effect waves-light" data-toggle="dropdown">
				                  		Action
